...
const HAS_OG_SKILL_REFERENCES = existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/references"));
...
test("every hand-over the og skill prints is one this script accepts", { skip: !HAS_OG_SKILL_REFERENCES }, () => {
