...
test("SKILL.md and AGENTS.md name the marker path and bound this script uses", { skip: !HAS_TEMPLATE_BRAND_DOCS }, () => {
...
test("the sections that own the brand-task prohibition never affirm a wait", { skip: !HAS_TEMPLATE_BRAND_DOCS }, () => {
...
test("SKILL.md tells the pass to self-check with the flag this CLI accepts", { skip: !HAS_TEMPLATE_BRAND_DOCS }, () => {
